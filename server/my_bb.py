...
def add(image, left, top, right, bottom, label=None, color=None):
    ...
    if label:
        ...
        rec_right_bottom = (rectangle_right+20, rectangle_bottom)

        _cv2.rectangle(image, rec_left_top, rec_right_bottom, color, -1)
        
        if flag :
            _cv2.putText(image, label, (rectangle_left, rectangle_top), 2,0.5,(255,255,255), 1)

        else:
            _cv2.putText(image, label, (rectangle_left, rectangle_top+8), 2,0.5,(255,255,255), 1)
